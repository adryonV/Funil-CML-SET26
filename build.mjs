...
//
// DATA MODEL (CML-SET26 — oferta "Café da Manhã Lucrativo", campanha CML | E6-VEN) ---
...
//   2) Lista de Compradores — aba "Cafe da Manha Lucrativo":
...
//      utm_content JÁ traz o nome do anúncio, URL-encoded): utm_campaign→campanha,
...
//
// A aba é DEDICADA a este lançamento (não há mistura de ofertas) — sem filtro de data.
//
...
// --- Sources ----------------------------------------------------------------
const ADS_ID    = '1QUht7rOCsZwuCD192xUajHaxyHc4-R3aeMPMkth5TBc';
const BUYERS_ID  = '1Qe1_LFcrd98hhOTa5rJAL78ZRUoHCZ-Pj4kIRgdiljI';
const SALES_GID  = '2131237735';                 // aba "Cafe da Manha Lucrativo"
const SALES_TAB  = 'Cafe da Manha Lucrativo';    // só rótulo p/ exibição

// Lemos a aba pelo GID (determinístico): esta planilha-mestre tem várias abas e o
// gviz por NOME às vezes resolve a errada.
...
(async () => {
  ...
  // ---------------- Sheet 2: buyers (aba "Cafe da Manha Lucrativo") ----------------
  ...
  const out = {
    meta: {
      title: 'Café da Manhã Lucrativo — Meta Ads',
      platform: 'Meta Ads',

# Funil de Tráfego — Café da Manhã Lucrativo (CML-SET26 · Meta Ads)
...
- **URL pública:** https://adryonv.github.io/Funil-CML-SET26/
...
Teto de **CAC = R$ 172** (definido pelo cliente). Bandas, piso de ROAS e tetos de
...
- **Method:** `POST`
- **URL:** `https://api.github.com/repos/adryonV/Funil-CML-SET26/dispatches`
- **Headers:**
